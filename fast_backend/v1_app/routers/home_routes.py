...
other_services_routes = APIRouter()

@other_services_routes.get('/get_whois')
...
@other_services_routes.get('/dns_lookup')
...
@other_services_routes.get('/get_ip')
...
@other_services_routes.get('/get_mx_record')
...
@other_services_routes.get('/get_register_Score')
def get_whois(domain_name: str = Query(...)):
    print(domain_name)
